...
def test_guard_migration_is_in_the_single_chain_and_operator_only():
    import runpy
    ...
    assert (
        ...
        == "043_owned_history_snapshot_rows"
    )
    assert EXPECTED_MIGRATION_HEAD == "043_owned_history_snapshot_rows"
