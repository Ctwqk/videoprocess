...
def _builtin_templates() -> list[WorkflowTemplate]:
    return [
        ...
        WorkflowTemplate(
            ...
            required_capabilities=["material_search", "source", "trim", "concat_timeline", "transcode", "export"],
